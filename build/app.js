...
var reduxMixin = (index && typeof index === 'object' && 'default' in index ? index['default'] : index);

var lodash = __commonjs(function (module, exports, global) {
/**
 * @license
...
var _ = (lodash && typeof lodash === 'object' && 'default' in lodash ? lodash['default'] : lodash);
...
var uuid = (index$1 && typeof index$1 === 'object' && 'default' in index$1 ? index$1['default'] : index$1);
...
var $$observable = (index$2 && typeof index$2 === 'object' && 'default' in index$2 ? index$2['default'] : index$2);
...
riot$1.tag2('launchpad', '<div class="row"> <div class="col-md-4" each="{launcher, index in items}"> <launchitem title="{launcher.title}" icon="{launcher.icon}" active="{index == activeIndex}"></launchitem> </div> </div>', '', '', function (opts) {
	var _this = this;
	...
	var selectNext = function selectNext() {
		...
		var ni = i + 1;
		if (ni >= _this.items.length) {
			ni = 0;
		}

		_this.dispatch(setActiveLauncher(_this.items[ni]));
	};
	...
	this.subscribe(function (state) {
		return {
			activeIndex: state.launchpad.launchers.indexOf(state.launchpad.launchers.find(function (x) {
				return x.id === state.launchpad.active;
			})),
