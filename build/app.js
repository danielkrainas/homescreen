...
var _ = nwbridge.require('lodash');
var uuid = nwbridge.require('uuid-v4');
...
var jsonfile = nwbridge.require('jsonfile');
...
var $$observable = (index$1 && typeof index$1 === 'object' && 'default' in index$1 ? index$1['default'] : index$1);
...
var _$1 = nwbridge.require('lodash');
...
function launcherReducer(state, action) {
	if (action.type === ADD_LAUNCHER) {
		...
		state = _$1.assign(_$1.cloneDeep(state), { active: action.launcherId });
	}
...
function reducer(state, action) {
	state = _$1.merge(_$1.clone(state), {
...
var exec = nwbridge.require('child_process').exec;
	...
	return function (next) {
		return function (action) {
			if (action.type == EXEC_LAUNCHER) {
				exec(action.launcher.cmd, function (err, b) {
					if (err) {
...
var path = nwbridge.require('path');

var config = null;

var HOME_CONFIG = path.join(process.env[process.platform === 'win32' ? 'USERPROFILE' : 'HOME'], './.homescreen.json');
